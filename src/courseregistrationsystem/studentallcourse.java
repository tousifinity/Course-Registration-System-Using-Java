 ...
 * @author Tousif
 */
public class studentallcourse extends javax.swing.JFrame {

    /**
     * Creates new form myprofile1
     */
    public studentallcourse() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(studentallcourse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new studentallcourse().setVisible(true);
            }
        });
    }
