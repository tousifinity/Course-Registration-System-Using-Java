 ...
 * @author Tousif
 */
public class teacherallstudent extends javax.swing.JFrame {

    /**
     * Creates new form myprofile1
     */
    public teacherallstudent() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(teacherallstudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new teacherallstudent().setVisible(true);
            }
        });
    }
